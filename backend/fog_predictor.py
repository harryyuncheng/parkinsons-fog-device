...
class FOGPredictor:
    ...
    def __init__(self, model_path='fog_classifier_20250622_003351.pth', sequence_length=128):
...
def initialize_predictor(model_path='fog_classifier_20250622_003351.pth'):
